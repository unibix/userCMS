...
class model_component_core_pages extends model {
	...
	/*
	* âîçâðàùàåò äî÷åðíèå ñòðàíèöû 1ãî óðîâíÿ âëîæåííîñòè
	* params:
	*   children_count - join column with count of children / äîáàâëÿåò ê âûáîðêå ñòîëáåö ñ êîëè÷åñòâîì äî÷åðíèõ ñòðàíèö
	*   content - join `pages` table with page content / äîáàâëÿåò ê âûáîðêå òàáëèöó `pages` ñ êîíòåíòîì
	*   sort - set 'sort by' value / óêàçûâàåò ïîðÿäîê ñîðòèðîâêè
	*
	*/
	...
	/*
	* âîçâðàùàåò äåðåâî\ñïèñîê âñåõ äî÷åðíèõ ñòðàíèö ëþáîãî óðîâíÿ âëîæåííîñòè
	*	
	*
	*/
	...
	/*
		óäàëåíèå ñòðàíèöû.
		(bool) recursive - óäàëåíèå äî÷åðíèõ ñòðàíèö
	*/
	...
	/*
		âîçâðàùàåò ñòðîêó ñ óðëîì ñòðàíèöû
	*/
	...
	/*
		ìåòîä äëÿ ïðîâåðêè ñóùåñòâîâàíèÿ óðëà.
		id - èäåíòèôèêàòîð ñòðàíèöû, êîòîðàÿ èñêëþ÷àåòñÿ èõ ïðîâåðêè
	*/
