...
$config = array(
    'root' => realpath(realpath(dirname(dirname(dirname(dirname(__FILE__)))).DIRECTORY_SEPARATOR.'..').DIRECTORY_SEPARATOR.'uploads'.DIRECTORY_SEPARATOR). DIRECTORY_SEPARATOR,
    // 'root' => __FILE__,
    'baseurl' => '/uploads/',
    'createThumb' => true,
    'thumbFolderName' => '.thumbs',
    'excludeDirectoryNames' => array('.tmb', '.quarantine'),
    'extensions' => array('jpg', 'png', 'gif', 'jpeg', 'doc','docx','odt', 'xls','xlsx','ods','pdf','zip'),
    'debug' => true,
);
